 ...
 * @return string
 */
function smarty_function_cyoa_input_text($params, $template) {
	...
	$defaults = array(
		...
		'attr' => array(
			...
			'id' => null,
			'value' => '',
			'type' => 'text',// 其他可选值：date,datetime,datetime-local,email,month,number,password,text,time,url,week,tel
			'disabled' => null,
			'max' => null,
			'min' => null,
			'maxlength' => null,
