...
class pinyin {
	 ...
	 * @param string $delimiter 转换后的拼音之间分隔符，默认为：半角空格
	 * @param boolean $ignore_other 是否忽略非汉字内容，默认为：false
	 * @return string
	 */
	 ...
	 * 转换为无声调的拼音字符串
	 * @param string $string 需要进行转换的字符串
	 * @param string $delimiter 转换后的拼音之间的分隔符
	 * @param boolean $ignore_other 是否忽略非汉字内容
	 * @return string
	 */
	 ...
	 * @param string $delimiter 字母之间的分隔符号
	 * @return string
	 */
