...
class Upload {
	...
	private $_media_type_maps = array(  
		// 音频、声音文件
		// D("PubApi/CommonAttachment")::MEDIA_TYPE_VOICE => array('mp3'),
		2 => array('mp3'),
		3 => array('mp4')
		// 视频文件
		 //D("PubApi/CommonAttachment")::MEDIA_TYPE_VIDEO => array('mp4')
	);
	...
	*/
	...
	public function get_file_info() {
		...
		$att = D('PubApi/CommonAttachment');
		$media_type = 0;
		if ($this->_is_image) {
			// 图片文件
			$media_type = $att::MEDIA_TYPE_IMAGE;
		} else {
			// 先初始化为普通文件
			$media_type = $att::MEDIA_TYPE_FILE;
			// 遍历以判断具体的文件类型
