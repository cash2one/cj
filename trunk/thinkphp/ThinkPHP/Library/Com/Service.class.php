...
abstract class Service {
	...
	public function get_errcode() {
		...
		return \Com\Error::instance()->get_errcode();
	}

	// 获取错误信息
	public function get_errmsg() {

		return \Com\Error::instance()->get_errmsg();
	}
	...
	public function get_by_conds($conds) {
		...
		try {
			return $this->_d->get_by_conds($conds);
		} catch (Exception $e) {
			E($e->getCode().":".$e->getMessage());
			return false;
		}
	...
	public function list_by_conds($conds, $page_option = null, $order_option = array()) {
		...
		try {
			return $this->_d->list_by_conds($conds, $page_option, $order_option);
		} catch (Exception $e) {
			E($e->getCode().":".$e->getMessage());
			return false;
		}
