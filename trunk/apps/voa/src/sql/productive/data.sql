INSERT INTO `{$prefix}productive_setting{$suffix}` (`pts_key`, `pts_value`, `pts_type`, `pts_comment`, `pts_status`, `pts_created`, `pts_updated`, `pts_deleted`) VALUES
('perpage', '10', 0, '分页数', 1, 0, 0, 0),
('pluginid', '22', 0, '插件id', 1, 0, 0, 0),
...
('score_rule_diy', '1', 0, '是否自定义评估规则', 1, 0, 0, 0),
