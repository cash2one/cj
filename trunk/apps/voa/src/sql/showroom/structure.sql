CREATE TABLE IF NOT EXISTS `{$prefix}showroom_article{$suffix}` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}showroom_article_content{$suffix}` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}showroom_article_member{$suffix}` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}showroom_article_right{$suffix}` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}showroom_article_search{$suffix}` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}showroom_category{$suffix}` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}showroom_category_right{$suffix}` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}showroom_setting{$suffix}` (
  ...
  `deleted` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '删除时间',
  PRIMARY KEY (`key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='陈列 - 设置表';
