CREATE TABLE `{$prefix}campaigns{$suffix}` (
...
CREATE TABLE `{$prefix}campaigns_department_p{$suffix}` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `actid` int(10) unsigned NOT NULL COMMENT '活动id',
  `cd_id` int(10) unsigned NOT NULL COMMENT '部门id',
  `is_show` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否展示1显示0隐藏',
  `status` tinyint(1) unsigned DEFAULT '1' COMMENT '记录状态, 1初始化，2=已更新, 3=已取消，4=已删除',
  `created` int(10) unsigned NOT NULL COMMENT '报名时间',
  `updated` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  `deleted` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=258 DEFAULT CHARSET=utf8 COMMENT='活动部门权限表';


CREATE TABLE `{$prefix}campaigns_mem_p{$suffix}` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `actid` int(10) unsigned NOT NULL COMMENT '活动id',
  `m_uid` int(10) unsigned NOT NULL COMMENT '部门id',
  `status` tinyint(1) unsigned DEFAULT '1' COMMENT '记录状态, 1初始化，2=已更新,3=已删除',
  `created` int(10) unsigned NOT NULL COMMENT '报名时间',
  `updated` int(10) unsigned DEFAULT NULL COMMENT '更新时间',
  `deleted` int(10) unsigned DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='活动用户权限表';

CREATE TABLE IF NOT EXISTS `{$prefix}campaigns_setting{$suffix}` (
...
CREATE TABLE IF NOT EXISTS `{$prefix}campaigns_share{$suffix}` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `{$prefix}campaigns_total{$suffix}` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `actid` int(10) unsigned NOT NULL COMMENT '活动id',
...
CREATE TABLE IF NOT EXISTS `{$prefix}campaigns_type{$suffix}` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `order_sort` INT unsigned DEFAULT '50' COMMENT '顺序(0-100)',
