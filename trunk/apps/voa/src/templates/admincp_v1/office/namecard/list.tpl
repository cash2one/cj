...
<div class="panel panel-default font12">
	<div class="panel-heading"><strong>搜素名片</strong></div>
...
<table class="table table-striped table-hover font12">
	...
	<thead>
		<tr>
			<th><label class="vcy-label-none"><input type="checkbox" id="delete-all" onchange="javascript:checkAll(this,'delete');"{if !$allowDelete} disabled="disabled"{/if} />删除</label></th>
			<th>创建者</th>
			<th>真实姓名</th>
			<th>手机号</th>
			<th>公司</th>
