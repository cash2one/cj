...
<!--
    ...
    <div class="form-group">
            ...
            <div class="panel">
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" name="item[it_alert_time]" >
                      {for $var=0 to 23}
                      <option value="{sprintf('%02s:00', $var)}" {if $data['it_alert_time'] == sprintf('%02s:00', $var)}selected{/if}>{sprintf('%02s:00', $var)}</option>
                      {/for}
                      </select>
                </div>    
         </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <div class="panel">
                      <select name="item[it_execution_status]" class="selectpicker execution-status col-lg-6">
