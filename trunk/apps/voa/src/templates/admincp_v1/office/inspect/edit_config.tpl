...
<form id="form-adminer-edit" class="form-horizontal font12" role="form" method="POST" action="">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" name="form[insi_rules]" placeholder="打分详细规则" value="{$form['insi_rules']}" />
        </div>
    </div>
    {/if}
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <input type="text" class="form-control" name="form[insi_score]" placeholder="该项分数" value="{$form['insi_score']}" />
        </div>
    </div>
    <div class="form-group">
