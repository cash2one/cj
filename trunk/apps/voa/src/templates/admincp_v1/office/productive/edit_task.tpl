...
<!--
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <div class="panel">
            <input type="text" name="item[ptt_title]" class="form-control task-title input-sm" value="{$data['ptt_title']|escape}" />
            </div>
        </div>
    </div>-->
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <div class="panel">
                <input type="hidden" class="users" value="{$data['ptt_assign_users']}" >
                <input type="hidden" name="item[ptt_assign_uid]" class="it-uid" value="{$data['ptt_assign_uid']}" >
        ...
        <div class="col-sm-5">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <select name="item[ptt_csp_id_list][]"  id='shop-list' multiple='multiple'>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            ...
            <div class="input-group date bootstrap-datepicker">
                ...
                <input class="date-field form-control it-start-date"  name="item[ptt_start_date]"  type="text" value="{$data['ptt_start_date']}" />                                
                </div>    
         </div>
         </div>
    </div>
    <div class="form-group plan">
        ...
        <div class="col-sm-10">
         <div class="radio">
            <label >
              <input type="radio" name="item[ptt_repeat_frequency]" value="no" {if $data['ptt_repeat_frequency']['no']}checked{/if}> 
              不重复
            </label>
          </div>
          <div class="radio">
            <label >
              <input type="radio" name="item[ptt_repeat_frequency]" {if $data['ptt_repeat_frequency']['day']}checked{/if} value="day"> 
              <div class="input-group  col-sm-3">
                  <div class="input-group-addon">每</div>
                  <input name="item[ptt_repeat_date_day]" value="{$data['ptt_repeat_frequency']['day']}" class="form-control input-sm " type="number" placeholder="1">
          ...
          <div class="radio">
            <label >
              <input type="radio" name="item[ptt_repeat_frequency]"  {if $data['ptt_repeat_frequency']['week']}checked{/if} value="week"> 
              <div class="input-group  col-sm-2">
                  <div class="input-group-addon">每周</div>
                  <select name="item[ptt_repeat_date_week]" class="selectpicker" >
          ...
          <div class="radio">
            <label >
              <input type="radio" name="item[ptt_repeat_frequency]" value="mon"  {if $data['ptt_repeat_frequency']['mon']}checked{/if}> 
              <div class="input-group  col-sm-2">
                  <div class="input-group-addon">每月</div>
                  <select name="item[ptt_repeat_date_mon]" class="selectpicker">
                  <option value="1" selected>1</option>
                  {for $var=2 to 31} 
                  <option value="{$var}" {if $var == $data['ptt_repeat_frequency']['mon']}selected{/if}>{$var}</option>
                  {/for}
                  </select>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-5">
            ...
            <div class="input-group date bootstrap-datepicker">
                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                <input type="text" class="date-field it-end-date form-control" value="{$data['ptt_end_date']}" name="item[ptt_end_date]">
                </div>    
         </div>
         </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-5">
            <div class="panel">
                <div class="input-group">
                    ...
                    <select class="form-control selectpicker" name="item[ptt_alert_time]" >
                      {for $var=0 to 23}
                      <option value="{sprintf('%02s:00', $var)}" {if $data['ptt_alert_time'] == sprintf('%02s:00', $var)}selected{/if}>{sprintf('%02s:00', $var)}</option>
                      {/for}
                      </select>
                </div>    
         </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <div class="panel">
                      <select name="item[ptt_execution_status]" class="selectpicker execution-status col-lg-6">
                      <option value="1" {if $data['ptt_execution_status'] == 1}selected{/if}>未开始</option>
                      <option value="2" {if $data['ptt_execution_status'] == 2}selected{/if}>马上执行</option>
                      {if $data['ptt_execution_status'] > 1 }
                      <option value="3" {if $data['ptt_execution_status'] == 3}selected{/if}>{if $data['ptt_execution_status']==2}撤消{else}已撤消{/if}</option>
                      {/if}
                      </select>
                </div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-5">
                <div class="panel">
                      <textarea name="item[ptt_description]" class="form-control ">{$data['ptt_description']}</textarea>
                </div>
            </div>
        </div>-->
    </div>
    <div class="text-center">
        <p class="bg-info"><input type="submit" name="submit" class="btn btn-primary" value="保存">
            &nbsp;&nbsp;
