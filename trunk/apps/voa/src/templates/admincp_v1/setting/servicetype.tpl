...
<div class="panel panel-default">
	<div class="panel-heading" id="panel-heading"><strong>欢迎使用畅移云工作平台！</strong><span class="font12 text-info">我是畅移小助手，会协助你开启畅移应用，请根据我的流程指引来操作，有问题可以咨询我们的客服QQ：4008606961</span></div>
...
<p class="alert alert-info">设置二维码地址：请参考下图，复制二维码地址粘帖到下方输入框</p>
<div class="row">
	<div class="col-sm-9">
	...
	<div class="col-sm-3 text-right"><button type="button" class="btn btn-lg btn-primary" onclick="javascript:check_qrcode();">下一步</button></div>
</div>
<p>&nbsp;</p>
<p class="well well-sm"><strong>1.1 </strong>登录微信企业号后台（http://qy.weixin.qq.com )，进入设置页面找到二维码图片，如下图所示：</p>
<p><img src="{$staticUrl}images/help/corpid_01.png" alt="" /></p>

<p class="well well-sm"><strong>1.2 </strong>将鼠标移到图片位置，点击鼠标右键，选择“复制图片网址”（适用于chrome浏览器），如下图所示：  </p>
<p><img src="{$staticUrl}images/help/corpid_02.png" alt="" /></p>

<p class="well well-sm"><strong>1.3 </strong>或点击“属性”复制图片地址（适用于其它浏览器），如下图所示：</p>
<p><img src="{$staticUrl}images/help/corpid_03.png" alt="" /></p>
</script>

<script type="text/template" id="step-2">
<p class="alert alert-info"><span class="pull-right"><button type="button" class="btn btn-info btn-xs" onclick="javascript:load_step(<%=step_prev%>);">上一步</button></span>将开发者凭据填写到下方即可：</p>
<div class="row">
	<div class="col-sm-9">
		<div class="form-horizontal">
	...
	<div class="col-sm-3 text-right"><button type="button" class="btn btn-lg btn-primary" onclick="javascript:check_corpid_secret();">下一步</button></div>
</div>
<p>&nbsp;</p>
<p class="well well-sm"><strong>2.1 </strong>点击设置页面“权限管理”一栏的“管理”按钮，如下图所示：</p>
<p><img src="{$staticUrl}images/help/corpid_04.png" alt="" />

<p class="well well-sm"><strong>2.2 </strong>进入权限管理页面，新建管理组。</p>
<p><img src="{$staticUrl}images/help/corpid_05.png" alt="" /></p>

<p class="well well-sm"><strong>2.3 </strong>进入刚刚建立好的管理组，找到开发者凭据，如下图所示：</p>
<p><img src="{$staticUrl}images/help/corpid_06.png" alt="" /></p>
</script>

<script type="text/template" id="step-3">
<p class="alert alert-info"><!-- <span class="pull-right"><button type="button" class="btn btn-info btn-xs" onclick="javascript:load_step(<%=step_prev%>);">上一步</button></span> -->请按如下图示步骤开启通讯录权限，并点击页面右下角“<strong>确认提交</strong>”按钮进行提交：</p>
<p>&nbsp;</p>
<p class="well well-sm"><strong>3.1 </strong>在刚才建立的管理组中，点击“修改组织架构选择”，如下图所示：</p>
<p><img src="{$staticUrl}images/help/corpid_07.png" alt="" /></p>

<p class="well well-sm"><strong>3.2 </strong>点击“修改组织架构选择”出现以下“选择组织架构”的弹窗，请选择顶级部门，不要选择顶级部门下的任何子部门</p>
<p><img src="{$staticUrl}images/help/corpid_08.png" alt="" /></p>

<p class="well well-sm"><strong>3.3 </strong>选择好顶级部门后，勾选管理权限。并确认敏感接口权限已全部打开。</p>
<p><img src="{$staticUrl}images/help/corpid_09.png" alt="" /></p>
</script>
