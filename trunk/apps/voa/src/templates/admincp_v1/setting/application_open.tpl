...
{if $plugin['cp_identifier']=='sign' }
	{include file='admincp/setting/application_sign_open.tpl'}
{else}
		...
		<div class="panel-body">
			<div class="row">
				<div class="step-line">
					...
					<div id="step-part-6" class="step-part">
						<strong>6</strong>
						<span>设置应用权限</span>
					</div>
				</div>
...
<script type="text/template" id="step-5">
	<p class="alert alert-warning">开启地理位置上报并修改上报方式</p>
	<p><img src="{$staticUrl}images/help/app_015.png" alt="" /></p>
	<p class="alert alert-warning">开启自定义菜单</p>
	<p><img src="{$staticUrl}images/help/app_016.png" alt="" /></p>
</script>
-->
