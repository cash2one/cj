...
<form name="inspect_tn" id="inspect_tn" method="post" action="{$form_action}">
	...
	<h1>门店名称</h1>
	{include file='frontend/mod_shop_select.tpl' spname='csp_id' jsonname='jsonstr' region2shop=$region2shop  plugin_set=$inspect_set}
