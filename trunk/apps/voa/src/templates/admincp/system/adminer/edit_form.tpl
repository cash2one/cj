...
{/if}
	...
	<div class="form-group">
		...
		<div class="col-sm-6">
			<select id="cagid" name="cag_id" size="1" class="form-control" data-width="auto"{if $adminer['ca_locked'] == $systemadminer} disabled="disabled"{/if}{if !$ca_id} required="required"{/if}>
