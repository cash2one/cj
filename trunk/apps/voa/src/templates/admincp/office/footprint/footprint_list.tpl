		...
		<form class="form-inline vcy-from-search" role="form" action="{$form_search_action_url}">
			...
			<div class="form-row">
				<div class="form-group">
					...
					<select id="id_fp_type" name="fp_type" class="form-control form-small" data-width="auto">
						<option value="">全部类型</option>
{foreach $footprint_type_list['type'] as $_type => $_name}
...
<table class="table table-striped table-hover font12">
	...
	<thead>
		<tr>
			<th class="text-left"><label class="vcy-label-none"><input type="checkbox" id="delete-all" onchange="javascript:checkAll(this,'delete');"{if !$delete_url_base || !$total} disabled="disabled"{/if} />删除</label></th>
			<th>轨迹提交人</th>
			<th>所在部门/职务</th>
			<th>类型/客户名称</th>
			<th>拜访时间</th>
