...
<div id="dailyreport-wechat-module" ui-view class=""></div>
...
<script type="text/javascript" src="/admincp/static/ng-modules/dailyreport/wechat-module.js" ></script>
<script type="text/javascript" src="/admincp/static/ng-modules/dailyreport/wechat-setting-ctrl.js" ></script>
...
<script>
    PolerEmbed.init($('#dailyreport-wechat-module'), ['app.modules.dailyreportwechat','ng.poler.plugins.pagination']);
</script>
