...
<div id="dailyreport-template-module" ui-view class=""></div>
...
<script type="text/javascript" src="/admincp/static/ng-modules/dailyreport/template-module.js" ></script>
<script type="text/javascript" src="/admincp/static/ng-modules/dailyreport/new-report-model-ctrl.js" ></script>
<script type="text/javascript" src="/admincp/static/ng-modules/dailyreport/report-template-ctrl.js" ></script>
...
<script>
    PolerEmbed.init($('#dailyreport-template-module'), ['app.modules.dailyreporttemplate','ng.poler.plugins.pagination']);
</script>
