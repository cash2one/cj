...
<div class="panel panel-default font12">
	<div class="panel-body">
		<div class="profile-row">
			<form class="form-horizontal font12" role="form" action="{$form_action_url}" method="post"
			      data-ng-app="ng.poler.plugins.pc">
				...
				<div id="user_dep_container">
					<div class="row">
						<label class="col-sm-2 text-right padding-sm">微信端可发起投票人员：</label>

						<div class="col-sm-9">
							<input type="hidden" class="form-small" id="is_all" name="is_all" value="{$default_all}"/>
							<button type="button" class="btn {if $default_all == 1}btn-primary{/if}" id="all_btn">全公司
							</button>
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<button type="button" class="btn {if $default_all == 0}btn-primary{/if}" id="specified_btn">
								指定对象
							</button>
						</div>
					</div>
					<div id="issue_sign" class="row {if $default_all == 1}none{/if} ">
						<div class="row">
							<div class="col-sm-2 col-md-offset-1 text-right padding-sm"
