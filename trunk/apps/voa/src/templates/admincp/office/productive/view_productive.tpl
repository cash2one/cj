...
<form id="form-adminer-edit" class="form-horizontal font12" role="form" method="POST" action="">
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <p class="form-control-static">{$productive['m_username']}</p>
        </div>
    </div>
    <div class="form-group">
        <label  class="col-sm-2 control-label">提交时间</label>
        <div class="col-sm-6">
               <p class="form-control-static">{$productive['pt_created']}</p>
        </div>
    </div>
    <div class="form-group">
        <label  class="col-sm-2 control-label">门店名称</label>
        <div class="col-sm-6">
               <p class="form-control-static">{$productive['csp_name']}</p>
        </div>
    </div>
    <div class="form-group">
        <label  class="col-sm-2 control-label">门店评份（{if $cache_config['score_rule_diy'] == 1}合格率{else}总分{/if}）</label>
        <div class="col-sm-6">
           <p class="form-control-static">{if $cache_config['score_rule_diy'] == 1}
            {$productive['score']}%
            {else}
            {$productive['score']}
            {/if}</p>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-6">
            <p class="form-control-static">{$mem['receiver']}</p>
         </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-6">
           <p class="form-control-static"> {$mem['bbc']} </p>
         </div>
    </div>
    <!--
   <div class="form-group">
