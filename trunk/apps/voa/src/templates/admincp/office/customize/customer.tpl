...
<script>
window._appname = "customer";
window._staticurl = "{$staticUrl}";
window._jsdir = "{$JSDIR}";
window._plusinid = "{$pluginid}";
</script>
<link rel="stylesheet" href="{$JSDIR}customized/app/customer/css/main.css" />
...
<script src="{$staticUrl}javascripts/customized/lib/requirejs/require.js" data-main="{$staticUrl}javascripts/customized/main.js"></script>
