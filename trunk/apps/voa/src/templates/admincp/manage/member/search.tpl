...
<div class="panel panel-default font12">
	<div class="panel-heading"><strong>搜索员工</strong></div>
		...
		<form class="form-inline vcy-from-search font12" role="form" action="{$formActionUrl}">
			...
			<div class="form-row">
				<div class="form-group">
					...
					<select id="id-job" name="cj_id" class="form-control form-small" data-width="auto">
	...
	{/foreach}
					...
					<select id="id-department" name="cd_id" class="form-control form-small" data-width="auto">
						<option value="-1">请选择……</option>
...
{include file="$tpl_dir_base/manage/member/list_common.tpl"}
