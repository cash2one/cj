...
{foreach $member_list as $_m}
		<tr>
			<td><label class="px-single"><input type="checkbox" class="px" name="id[{$_m['m_uid']}]" value="{$_m['m_uid']}"{if !$form_delete_action_url} disabled="disabled"{/if} /><span class="lbl"> </span></label></td>
