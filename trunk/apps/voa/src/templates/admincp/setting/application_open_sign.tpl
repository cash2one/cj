...
<script type="text/template" id="step-5">
	<p class="alert alert-warning __top">开启地理位置上报</p>
	<p><img src="{$IMGDIR}help/app_sign_1.png" alt="" /></p>
	<p class="alert alert-warning">修改上报用户地理位置</p>
	<p><img src="{$IMGDIR}help/app_sign_2.png" alt="" /></p>
	<p class="alert alert-warning">在用户处于应用中时，每5秒上报一次</p>
	<p><img src="{$IMGDIR}help/app_sign_3.png" alt="" /></p>
</script>
