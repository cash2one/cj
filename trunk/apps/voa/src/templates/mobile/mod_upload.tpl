<div class="upload ui-border-t">
    <div class="ui-badge-wrap">
        <div class="ui-badge-cornernum add"></div>
    </div>
    <div class="ui-badge-wrap">
        <div class="ui-badge-cornernum add"></div>
    </div>
    <div class="ui-badge-wrap"></div>
    <div class="ui-badge-wrap"></div>
...
<div class="mod_photo_uploader" data-num-finished="{$attach_total}">
	...
	<a href="javascript:void(0)" class="photo" data-result="{ldelim}&quot;id&quot;:{$att['at_id']}{rdelim}">
		<img src="{voa_h_attach::attachment_url($att['at_id'], 45)}?ts={$timestamp}&sig={voa_h_attach::attach_sig_create($att['at_id'])}" data-big="{voa_h_attach::attachment_url($att['at_id'], 640)}" />
