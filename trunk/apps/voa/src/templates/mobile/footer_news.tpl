...
<script type="text/javascript" src="{$wbs_javascript_path}/h5mod/textarea.js?_t={if 'test.vchangyi.com' == $domain || 'local.vchangyi.net' == $domain}{$timestamp}{else}{rgmdate($timestamp,'Ymd')}{/if}"></script>
<script type="text/javascript" src="{$wbs_javascript_path}/h5mod/upload_image_news.js?_t={if 'test.vchangyi.com' == $domain || 'local.vchangyi.net' == $domain}{$timestamp}{else}{rgmdate($timestamp,'Ymd')}{/if}"></script>
