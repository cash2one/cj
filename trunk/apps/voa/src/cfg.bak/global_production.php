...
$conf = array(
	...
	// formhash
	'formhash_secret' => 'formhash_secret',
	'api_secret' => 'this is api secret',
	...
	'uc_url' => 'http://uc.vchangyi.com/',//UC 根目录Url
	'main_url' => 'http://www.vchangyi.com/',// 主站根目录url
	'cyadmin_url' => 'http://cy.admin.vchangyi.com/',// 主站后台URL

	'oa_http_scheme' => 'http://',// OA企业站HTTP协议，https:// 或 http://

	'smscode_send_frequency' => 60,// 同一手机号 或 同一IP两次发送手机短信验证码的间隔时间。单位：秒。必须大于10
	'smscode_send_expire' => 1800,// 验证码有效期
	'smscode_send' => true,// 是否发送验证码短信，调试时可关闭，避免频繁发送
	'app_news_h5' => '/h5/index.html#/app/page/',//新闻公告首页地址
	'install_mode' => 1, // 1: 通用; 2: 独立部署
);
