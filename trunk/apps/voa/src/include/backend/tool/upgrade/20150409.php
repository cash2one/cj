...
/**
 * 活动报名上线脚本
 * php -q tool.php -n upgrade -version 20150409 -epid vchangyi_oa_upgrade
 * User: tim_zhang
 * Date: 15/3/31
 * Time: 上午10:27
 */
class execute {
    ...
    protected function _open_plugin() {
        ...
        $plugin_name = '活动报名';
        // 描述
        $plugin_description = '员工在微信上快速组织活动，参与活动，随时查看活动进度，帮助企业打造更融洽的公司氛围';
