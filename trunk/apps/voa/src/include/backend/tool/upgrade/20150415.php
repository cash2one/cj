...
/**
 * 快递助手上线脚本
 * php -q tool.php -n upgrade -version 20150415 -epid vchangyi_oa_upgrade
 * Create By Deepseath
 * $Author$
 * $Id$
 */
class execute {
	...
	protected function _open_plugin() {
		...
		$plugin_name = '快递助手';
		// 描述
		$plugin_description = '高效管理接收快递流程，前台人员代收快递，扫一扫快速核销领取记录';
		...
		$this->_db->query("INSERT INTO `oa_common_plugin` (`cp_identifier`,
				...
				'{$this->__identifier}', 1, {$cpg_id}, '', '', 1031, 0, 0, '{$plugin_name}', '{$this->__identifier}.png',
