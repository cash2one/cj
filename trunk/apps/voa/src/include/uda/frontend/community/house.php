...
class voa_uda_frontend_community_house extends voa_uda_frontend_community_abstract {
	...
	public function execute($request, &$result) {
		...
		$this->_house_formt($data, $result);//格式化todo
		return true;
	}
	 ...
	 * @return bool
	 */
	protected function _house_formt($request, &$result) {
