...
/**
 * voa_uda_frontend_invite_delete
 * 邀请人员/uda/删除数据
 * Created by zhoutao.
 * Created Time: 2015/7/8  17:23
 */
class voa_uda_frontend_invite_delete extends voa_uda_frontend_invite_base {
	/** service 类*/
	...
	public function delete_invites( $ids ) {
		try {
			...
			return $this->set_errmsg( voa_errcode_oa_invite::DELETE_INVITE_FAILED );
		}
