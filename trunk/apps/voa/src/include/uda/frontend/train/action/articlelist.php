<?php
/**
 * voa_uda_frontend_train_action_articlelist
 * 统一数据访问/培训/文章列表
 *
 * $Author$
 * $Id$
...
class voa_uda_frontend_train_action_articlelist extends voa_uda_frontend_train_abstract {
	...
	public function list_right_artilce($m_uid, $tc_id, $page_option, &$list) {
		...
		$articleright = new voa_d_oa_train_articleright();
		$article = new voa_d_oa_train_article();
	...
	protected function _get_plus_info($list, $read_ids) {
		...
		$d_categories = new voa_d_oa_train_category();
