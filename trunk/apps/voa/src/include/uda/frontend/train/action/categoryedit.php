<?php
/**
 * voa_uda_frontend_train_action_categoryedit
 * 统一数据访问/培训/编辑目录
 *
 * $Author$
 * $Id$
...
class voa_uda_frontend_train_action_categoryedit extends voa_uda_frontend_train_abstract {
	...
	public function get_rights($id, &$category) {
		...
		$d_category_right = new voa_d_oa_train_categoryright();
