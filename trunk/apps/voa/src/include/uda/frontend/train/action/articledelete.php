<?php
/**
 * voa_uda_frontend_train_action_articledelete
 * 统一数据访问/培训/删除文章
 *
 * $Author$
 * $Id$
...
class voa_uda_frontend_train_action_articledelete extends voa_uda_frontend_train_abstract {
	...
	public function delete($ids) {
		...
		try {
			...
			return $this->set_errmsg(voa_errcode_oa_train::DELETE_ARTICLE_FAILED);
		}
		return true;
	}
