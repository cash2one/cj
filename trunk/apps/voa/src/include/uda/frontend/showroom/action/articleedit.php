<?php
/**
 * voa_uda_frontend_showroom_action_articledit
 * 统一数据访问/陈列/编辑文章
 *
 * $Author$
 * $Id$
...
class voa_uda_frontend_showroom_action_articleedit extends voa_uda_frontend_showroom_abstract {
	...
	public function edit($id, &$data) {
		...
		if ($id) { //编辑文章
			...
			try{
				...
				return $this->set_errmsg(voa_errcode_oa_showroom::EDIT_ARTICLE_FAILED);
			}
			...
			try{
				...
				return $this->set_errmsg(voa_errcode_oa_showroom::ADD_ARTICLE_FAILED);
			}
		}
		$data['ta_id'] = $id;
