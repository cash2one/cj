 ...
 * $Id$
 */
class voa_c_api_workorder_post_confirm extends voa_c_api_workorder_abstract {
	...
	public function execute() {
		...
		$request = array(
			...
			'action' => voa_d_oa_workorder::ACTION_CONFIRM,
			'admin' => false,
			'data' => array(),
		);
		...
		$uda_wxqynotice->confirm($this->_params['id'], $this->_member['m_uid'], $this->session);
