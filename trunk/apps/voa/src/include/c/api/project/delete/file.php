<?php
/**
 * voa_c_api_project_delete_file
 * 【应用:任务】删除文件接口
 * Create By Deepseath
 * $Author$
 * $Id$
 */
class voa_c_api_project_delete_file extends voa_c_api_project_base {
	...
	public function execute() {
		...
		if (empty($pat_ids)) {
			$this->_set_errcode(voa_errcode_api_project::DELETE_ID_NULL);
		}
