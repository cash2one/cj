<?php
/**
 * voa_c_api_showroom_get_view
 * 获取一篇文章
 * $Author$
 * $Id$
 */

class voa_c_api_showroom_get_view extends voa_c_api_showroom_abstract {
	...
	public function execute() {
		...
		if (!$article) { //判断文章是否存在
			return $this->_set_errcode(voa_errcode_oa_showroom::ARTICLE_NOT_EXIST);
		}
		...
		if ($article['is_all'] == voa_d_oa_showroom_articleright::IS_ALL) { //如果全部人员都可查看
			return true;
		}
		...
		return $this->_set_errcode(voa_errcode_oa_showroom::ARTICLE_NO_RIGHT);
	}
