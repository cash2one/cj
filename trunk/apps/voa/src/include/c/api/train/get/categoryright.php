<?php
/**
 * voa_c_api_train_get_categoryright
 * 获取一篇文章
 * $Author$
 * $Id$
 */

class voa_c_api_train_get_categoryright extends voa_c_api_train_abstract {
	...
	public function execute() {
		...
		if (1 > $tc_id) {
			return $this->_set_errcode(voa_errcode_oa_train::CATEGORY_ID_ERROR);
		}
