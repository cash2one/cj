<?php
/**
 * voa_c_api_travel_get_customertablecolopt
 * 获取表格列选项信息
 * $Author$
 * $Id$
 */

class voa_c_api_travel_get_customertablecolopt extends voa_c_api_travel_customerabstract {
	...
	public function execute() {
		...
		// 遍历属性, 看单选/复选中是否有附件
		$columns = voa_h_cache::get_instance()->get('plugin.travel.customertablecol', 'oa');
		foreach ($list as &$_v) {
