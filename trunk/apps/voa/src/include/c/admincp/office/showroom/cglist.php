<?php
/**
 * voa_c_admincp_office_showroom_cglist
 * 企业后台/微办公管理/陈列/目录列表
 * Create By YanWenzhong
 * $Author$
 * $Id$
 */
class voa_c_admincp_office_showroom_cglist extends voa_c_admincp_office_showroom_base {
	...
	public function execute() {
		...
		// 输出模板
		$this->output('office/showroom/category_list');
	}
