...
* $Id$
*/
class voa_c_admincp_office_jobtrain_add extends voa_c_admincp_office_jobtrain_base {
	...
	public function execute() {
		...
		if ($this->_is_post()) {
			...
			try {
				$args = array(
					'm_uid' => $this->_user['ca_id'],
					'm_username' => $this->_user['ca_username']
				);
		...
		$result = array(
			...
			'audimgs' => array(),
			'attachs' => array(),
			'audimgs_json' => rjson_encode(array()),
			'attachs_json' => rjson_encode(array())
		);
