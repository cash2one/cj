...
class voa_c_frontend_reimburse_verify_approve extends voa_c_frontend_reimburse_verify {
	...
	public function execute() {
		...
		$this->_success_message('报销操作成功', "/reimburse/view/".$this->_reimburse['rb_id']);
	}
}
