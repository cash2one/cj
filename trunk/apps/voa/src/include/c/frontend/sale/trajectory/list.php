...
class voa_c_frontend_sale_trajectory_list extends voa_c_frontend_sale_base {
	...
	public function execute() {
		...
		$this->view->set('navtitle', '轨迹管理');
		$this->view->set('statuses', $statuses);
		$this->view->set('sources', $sources);
		// 引入应用模板
		$this->_output('mobile/'.$this->_plugin_identifier.'/trajectory');
