...
class voa_c_frontend_nvote_base extends voa_c_frontend_base {
    ...
    protected function _get_plugin() {
        ...
        // 取应用配置
        $this->_p_sets = voa_h_cache::get_instance()->get('plugin.nvote.setting', 'oa');
        // 取应用插件信息
	 ...
	 * 获取投票调研配置
	 */
	public static function fetch_cache_nvote_setting() {

		$serv = &service::factory('voa_s_oa_nvote_setting');
		$data = $serv->list_all();
		$arr = array();
		$_pluginid = - 1;
		foreach ($data as $v) {
