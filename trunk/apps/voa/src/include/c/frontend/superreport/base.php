 ...
 * $Id$
 */
class voa_c_frontend_superreport_base extends voa_c_frontend_base {

	/** 当前应用唯一标识符 */
	protected $_identifier = 'superreport';
	 ...
	 * @return array
	 */
	public static function fetch_cache_superreport_setting() {

		// 应用唯一标识名
		$identifier = 'superreport';
		$sets = array();
		$d_superreport_setting = new voa_d_oa_superreport_setting();
		foreach ($d_superreport_setting->list_all() as $s) {
		...
		self::_check_agentid($sets, 'superreport');
		return $sets;
	}
