 ...
 * $Id$
 */
class voa_c_frontend_train_base extends voa_c_frontend_base {

	/** 当前应用唯一标识符 */
	protected $_identifier = 'train';
	 ...
	 * @return array
	 */
	public static function fetch_cache_train_setting() {
		...
		self::_check_agentid($sets, 'train');
		return $sets;
	}
