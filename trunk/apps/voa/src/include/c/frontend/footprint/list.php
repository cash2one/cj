...
class voa_c_frontend_footprint_list extends voa_c_frontend_footprint_base {
	protected $_start;
	protected $_perpage;
	protected $_page;
	protected $_updated;
	...
	public function execute() {
		...
		$list = $serv->fetch_by_uid_search($uid, $conditions, $this->_start, $this->_perpage);
		...
		$this->view->set('userinfo', $userinfo);
