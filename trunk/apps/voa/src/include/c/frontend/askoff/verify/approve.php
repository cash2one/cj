...
class voa_c_frontend_askoff_verify_approve extends voa_c_frontend_askoff_verify {
	...
	public function execute() {
		...
		$this->_success_message('请假操作成功', "/askoff/view/".$this->_askoff['ao_id']);
	}
}
