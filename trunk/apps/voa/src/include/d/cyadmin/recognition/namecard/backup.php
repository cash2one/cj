<?php
/**
 * voa_d_cyadmin_recognition_namecard_backup
 * 畅移后台/识别名片/备份表
 * Create By Deepseath
 * $Author$
 * $Id$
...
class voa_d_cyadmin_recognition_namecard_backup extends dao_mysql {
	/** 表名 */
	public static $__table = 'cyadmin.recognition_namecard_backup';
	/** 主键 */
	private static $__pk = 'rnc_id';
	/** 字段前缀 */
	private static $__prefix = 'rnc_';
