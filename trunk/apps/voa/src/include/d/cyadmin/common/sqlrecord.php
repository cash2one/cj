<?php
/**
 * voa_d_cyadmin_common_sqlrecord
 * SQL日志数据表
 * $Author$
 * $Id$
 */

class voa_d_cyadmin_common_sqlrecord extends dao_mysql {
	/** 表名 */
	public static $__table = 'cyadmin.common_sqlrecord';
	/** 主键 */
	private static $__pk = 'id';
	/** 字段前缀 */
