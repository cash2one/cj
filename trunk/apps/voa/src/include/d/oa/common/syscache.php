...
class voa_d_oa_common_syscache extends dao_mysql {
	/** 表名 */
	public static $__table = 'oa.common_syscache';
	/** 主键 */
	...
	public static function list_all($shard_key = array()) {

		return parent::_fetch_all(self::$__table, "SELECT * FROM %t WHERE csc_status<%d", array(
