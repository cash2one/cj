...
;(function ($, window, undefined)
{
    ...
    */
    ...
    function loadData()
    {
        ...
        if (this.options.ajax && (url == null || typeof url !== "string" || url.length === 0) && this.options.data == '')
        {
        ...
        if (this.options.data != '') {
        	...
        	this.options.data(request, function (data) {
    ...
    Grid.defaults = {
        ...
        labels: {
            all: "全部",
            infos: "显示 {{ctx.start}} 至 {{ctx.end}}， 共 {{ctx.total}} 条信息",
            loading: "加载中...",
            noResults: "没有数据!",
            refresh: "刷新",
            search: "搜索"
        ...
        templates: {
            ...
            header: "<div id=\"{{ctx.id}}\" class=\"{{css.header}}\"><div class=\"row\"><div class=\"col-sm-2 table-current-postion\"></div><div class=\"col-sm-8 actionBar pull-right\"><p class=\"{{css.search}}\"></p><p class=\"{{css.actions}}\"></p></div></div></div>",
