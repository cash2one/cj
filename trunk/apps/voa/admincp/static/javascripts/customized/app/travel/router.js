define(['require_router', "jquery", "underscore"], function(router, $, _) {
    ...
    router
        .registerRoutes({
            ...
            copy: { path: '/copy/:id', moduleId: 'views/copy' },
        ...
        .on('routeload', function(module, routeArguments) {
        	...
        	el_subnav.find(".nav").append('<li><a href="?act=customer"><i class="fa fa-list"></i> 客户列表</a></li>');
        	el_subnav.find(".nav").append('<li class="goods-list" ><a href="#/list"><i class="fa fa-cloud"></i> 产品列表</a></li>');
        	//el_subnav.find(".nav").append('<li class="goods-cate"><a href="#/cate"><i class="fa fa-sitemap"></i> 产品分类</a></li>');
        	//el_subnav.find(".nav").append('<li class=""><a href="?act=customer#/config"><i class="fa fa-gear"></i> 客户配置</a></li>');
        	//el_subnav.find(".nav").append('<li class="goods-config"><a href="#/config"><i class="fa fa-gear"></i> 产品配置</a></li>');
