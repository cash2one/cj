(function(h, o, g) {
	...
	g[h] = {
		...
		createPlayer: function(b, a, c) {
			...
			if (e.outerHTML && !document.createElement("audio").canPlayType) {
				...
				d.innerHTML = a.markup + b.outerHTML;
				/* d.appendChild(e); */
		...
		attachFlashEvents: function(b, a) {
			...
			a.play = function() {
				...
				a.playing = true;
				if (a.element.pplay) a.element.pplay();
		...
		helpers: {
			merge: function(b, a) {
				for (var attr in a) if (b.hasOwnProperty(attr) || a.hasOwnProperty(attr)) b[attr] = a[attr]
			},
			clone: function(b) {
	...
	g[o].prototype = {
		...
		play: function() { / (ipod | iphone | ipad) / i.test(navigator.userAgent) && this.element.readyState == 0 && this.init.apply(this);
