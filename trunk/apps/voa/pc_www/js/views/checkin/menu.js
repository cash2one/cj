define([
  ...
  'text!templates/checkin/menu.html'
], function($, _, Backbone, appUtils, theTmpl){

  var CheckinMenuView = Backbone.View.extend({
	...
	render: function(){
		...
		appUtils.doSyncGet('/checkin/menu',  _.bind(this.onGet, this));
		//console.log('[CheckinMenuView] render');
		return this;
    },
	...
	clickItem: function(e){ //直接渲染 避免页面整体重建
		...
		_appFacade.router.checkinPagesAction(action, false);
		window._appFacade.router.navigate('checkin/' + action, {trigger: false});
