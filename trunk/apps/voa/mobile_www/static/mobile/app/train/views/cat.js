define(["views/base", "data/train", "utils/render", "text!templates/cat.html", "text!templates/cat_data.html", 'jquery', "iscrollview"
    ...
    view.prototype.render = function(args) {
        var self = this;
        // 数据业务处理处
        train.get_cat({page: this.page_number, limit: this.page_limit}, function (ret) {
