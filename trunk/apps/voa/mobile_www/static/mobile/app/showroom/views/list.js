...
define(["views/base", "data/showroom", "utils/render", "text!templates/list.html", "text!templates/list_data.html", 'jquery', "iscrollview"
    ...
    view.prototype.render = function(args) {
        ...
        // 数据业务处理处
        showroom.get_list({page: this.page_number, limit: this.page_limit, tc_id: args.id}, function (ret) {
    ...
    view.prototype.got_pull_up_data = function (event, data, callback) {
    	var self = this;
    	showroom.get_list({page: this.page_number, limit: this.page_limit, tc_id: view.prototype.tc_id}, function (ret) {
    		var r = new render();
    		var son = r.parse_template(tpl_list_data, {ls: ret});
